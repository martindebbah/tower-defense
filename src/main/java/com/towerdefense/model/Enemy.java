...
public class Enemy {
    ...
    public Tile shorterPath(int fx, int fy, Board board){ // application de l'algo A*
        ...
        current.setQuality(dist(current.getX()/board.getSize() + (current.getX()%board.getSize() == 0 ? 0 : 1), current.getY()/board.getSize() + (current.getY()%board.getSize() == 0 ? 0 : 1), fx, fy));
        closed.add(current);
    ...
    public Tile getFirstTile(Board board) {
        ...
        */
        switch (direction) {
            ...
            case 2: return board.getBoard()[x / board.getSize() + 1][y / board.getSize()];
            case 3: return board.getBoard()[x / board.getSize()][y / board.getSize()];
            case 4: return board.getBoard()[x / board.getSize()][y / board.getSize() + 1];
            case 5: return board.getBoard()[x / board.getSize() + 1][y / board.getSize() + 1];
            case 6: return board.getBoard()[x / board.getSize()][y / board.getSize() + 1];
            case 7: return board.getBoard()[x / board.getSize() + 1][y / board.getSize()];
            case 8: return board.getBoard()[x / board.getSize()][y / board.getSize()];
        }
